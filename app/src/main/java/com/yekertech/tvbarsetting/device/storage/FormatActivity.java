...
import com.yekertech.tvbarsetting.util.SettingsAsyncTaskLoader;
...
public class FormatActivity extends Activity
    ...
    public static final String INTENT_ACTION_FORMAT_AS_PRIVATE =
            "com.yekertech.tvbarsetting.device.storage.FormatActivity.formatAsPrivate";
    public static final String INTENT_ACTION_FORMAT_AS_PUBLIC =
            "com.yekertech.tvbarsetting.device.storage.FormatActivity.formatAsPublic";
