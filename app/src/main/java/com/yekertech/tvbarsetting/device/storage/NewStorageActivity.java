...
//import com.yekertech.tvbarsetting.device.StorageResetActivity;
...
public class NewStorageActivity extends Activity {
    ...
    private static final String ACTION_NEW_STORAGE =
            "com.yekertech.tvbarsetting.device.storage.NewStorageActivity.NEW_STORAGE";
    private static final String ACTION_MISSING_STORAGE =
            "com.yekertech.tvbarsetting.device.storage.NewStorageActivity.MISSING_STORAGE";
        ...
        public void onGuidedActionClicked(GuidedAction action) {
            switch ((int) action.getId()) {
                case ACTION_FORMAT_AS_PUBLIC:
                    ...
                    break;
                case ACTION_BROWSE:
                    startActivity(new Intent(getActivity(), null));//StorageResetActivity.class
                    break;
