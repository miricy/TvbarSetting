...
public class MenuItem {
    ...
    public static class Builder {
        ...
        public Builder from(MenuItem item) {
            mId = item.mId;
            mBackgroundColor=item.mBackgroundColor;
        ...
        public MenuItem build() {
            return new MenuItem(mId, mTitle,mBackgroundColor, mDescriptionGetter, mImageUriGetter,
                    mIntent);
        }
    }
    ...
    private MenuItem(int id, String displayName,int backgroundColor,
