...
import com.yekertech.tvbarsetting.dialog.Layout.LayoutGetter;
import com.yekertech.tvbarsetting.dialog.Layout.SelectionGroup;
...
public class NetworkActivity extends SettingsLayoutActivity implements
    ...
    LayoutGetter mVPNLayout = new LayoutGetter() {
        public Layout get() {
            ComponentName componentName = new ComponentName("com.yekertech.tvbarsetting",
                "com.yekertech.tvbarsetting.accessories.AddAccessoryActivity");
